      ...
      <div className="max-w-5xl mx-auto px-6 w-full">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="text-muted text-base mb-8 max-w-md leading-relaxed text-left">
              <p>
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <a
                ...
                className="border border-accent text-accent font-semibold text-xs px-2.5 py-2 rounded hover:bg-accent hover:text-bg transition-all no-underline flex items-center gap-1.5"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="#FF0000">
              ...
              <a
                ...
                className="border border-accent text-accent font-semibold text-xs px-2.5 py-2 rounded hover:bg-accent hover:text-bg transition-all no-underline flex items-center gap-1.5"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="var(--color-github)">
              ...
              <a
                ...
                className="border border-accent text-accent font-semibold text-xs px-2.5 py-2 rounded hover:bg-accent hover:text-bg transition-all no-underline flex items-center gap-1.5"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="#0A66C2">
          ...
          <div className="hidden md:flex flex-col gap-5">
            ...
            <div
              data-theme="dark"
              className="bg-surface border border-border rounded-xl overflow-hidden font-mono text-sm"
            >
              {/* Bar */}
              <div
