          ...
          <div>
            ...
            <div className="flex gap-3 justify-center">
              <a
                ...
                className="border border-accent text-accent font-semibold text-sm px-4 py-2.5 rounded-lg hover:bg-accent hover:text-bg transition-all no-underline flex items-center gap-2"
              >
