            ...
            <div className="flex justify-center md:justify-start">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="border border-accent text-accent font-semibold text-sm px-6 py-3 rounded hover:bg-accent hover:text-bg transition-all no-underline text-center flex items-center gap-2"
                >
              ...
              <a
                ...
                download
                className="w-full border border-accent text-accent font-semibold text-sm px-6 py-3 rounded hover:bg-accent hover:text-bg transition-all no-underline text-center"
              >
                ↓ Download Resume
              </a>
              </div>
