    ...
    <section id="youtube" className="py-20 bg-bg">
      <div className="max-w-5xl mx-auto px-6">
        <div className="reveal mb-10">
          <p className="font-mono text-accent text-xs tracking-widest uppercase mb-2">Content I create</p>
        ...
        <div className="grid md:grid-cols-3 gap-8 items-start">
          ...
          <div className="reveal bg-surface border border-border rounded p-6 text-center">
            ...
            <p className="text-muted text-sm mb-5 leading-relaxed">
              Practical SAP tutorials for developers who already know modern JavaScript frameworks.
            </p>
          ...
          <div className="reveal md:col-span-2 flex flex-col gap-3">
            {videos.map((v) => (
              <div key={v.num}
                ...
                <div className="font-mono text-xs text-accent pt-0.5 min-w-8">{v.num}</div>
                <div>
                  <div className={`text-sm font-medium mb-1 ${v.live ? 'text-textmain' : 'text-muted'}`}>
                    {v.title}
                  </div>
