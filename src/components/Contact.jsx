    ...
    <section id="contact" className="py-20 bg-surface">
      <div className="max-w-5xl mx-auto px-6">
        <div className="max-w-lg mx-auto text-center reveal">
          <p className="font-mono text-accent text-xs tracking-widest uppercase mb-2">Let's connect</p>
          <h2 className="font-display font-extrabold text-textmain mb-6"
          ...
          <p className="text-muted text-base leading-relaxed mb-8">
            ...
            If you're building something interesting or want to collaborate on SAP content — reach out.
          </p>
