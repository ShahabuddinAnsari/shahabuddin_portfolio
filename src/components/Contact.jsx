      ...
      <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:flex gap-3 mx-auto mt-2 max-w-xs md:max-w-none md:justify-center">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="border border-accent text-accent font-semibold text-sm px-4 py-3 rounded hover:bg-accent hover:text-bg transition-all no-underline flex items-center justify-center gap-2 whitespace-nowrap md:flex-1 md:max-w-[160px]"
            >
