    ...
    <section id="projects" className="py-20 bg-surface">
      <div className="max-w-5xl mx-auto px-6">
        <div className="reveal mb-10">
          <p className="font-mono text-accent text-xs tracking-widest uppercase mb-2">Things I've built</p>
        ...
        <div className="grid gap-5" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))' }}>
          {projects.map((p) => (
            <div key={p.title}
              ...
              <div className="font-mono text-xs text-accent2 tracking-wider uppercase mb-3">{p.type}</div>
              ...
              <div className="flex flex-wrap gap-1.5 mt-4 pt-4 border-t border-border">
                {p.tags.map((t) => (
                  <span key={t}
                        ...
                        style={p.hot.includes(t) ? { background: 'rgba(0,212,170,0.12)' } : {}}>
                    {t}
                  </span>
                ))}
              </div>
