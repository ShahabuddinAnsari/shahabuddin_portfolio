    ...
    <section id="skills" className="py-20 bg-surface">
      <div className="max-w-5xl mx-auto px-6">
        <div className="reveal mb-10">
          <p className="font-mono text-accent text-xs tracking-widest uppercase mb-2">What I work with</p>
        ...
        <div className="grid gap-4" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))' }}>
          {skills.map((card) => (
            <div key={card.title}
              ...
              <div className="font-display font-bold text-textmain text-base mb-3">{card.title}</div>
